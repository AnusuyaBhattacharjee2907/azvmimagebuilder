...
$packageRepo = 'C:\//choco-setup//packages'
...
# UPDATE THIS PATH
$localChocolateyPackageFilePath = 'E:\//20R1-FTP//chocolatey.0.10.15.nupkg'
# Determine unzipping method
# 7zip is the most compatible, but you need an internally hosted 7zach.exe.
